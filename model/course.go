...
type Course struct {
	...
	IsPdfDownload      uint8  `json:"is_pdf_download"`      // 是否pdf下载 0 否 1 是
	IsMarkdownDownload uint8  `json:"is_markdown_download"` // 是否md下载 0 否 1 是
	IsVideoDownload    uint8  `json:"is_video_download"`    // 是否视频下载 0 否 1 是
	IsAudioDownload    uint8  `json:"is_audio_download"`    // 是否音频下载 0 否 1 是
